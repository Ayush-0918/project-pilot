...
export default function CareerScorePage() {
  ...
  return (
    <div className="w-full space-y-6 sm:space-y-8 pb-12 px-6 sm:px-4 min-w-0 overflow-x-hidden">
      {/* Title Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="min-w-0 pt-6 sm:py-4 pb-6 px-6 sm:px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        >
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2 sm:pt-4 items-center flex-1 p-4 sm:p-6">
            {/* Massive Circular score indicator */}
        ...
        >
          ...
          <CardContent className="space-y-4 pt-1 flex-1 text-xs p-4 sm:p-6">
            <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <Card hoverEffect={true} className="bg-[#08051e]/40 lg:col-span-2 overflow-hidden">
          ...
          <CardContent className="space-y-3 pt-1 p-4 sm:p-6">
            {careerScore.missingSkills.map((gap, idx) => {
              const badgeColors = {
                High: "bg-rose-500/10 border-rose-500/20 text-rose-300 shadow-[0_0_8px_rgba(244,63,94,0.15)]",
                Medium: "bg-amber-500/10 border-amber-500/20 text-amber-300",
              ...
              return (
                <div
                  key={idx}
                  className="p-3 sm:p-4 bg-white/2 rounded-xl border border-white/5 flex flex-col sm:flex-row sm:items-center justify-between text-xs sm:text-sm text-slate-300 gap-2 sm:gap-4"
                >
        ...
        >
          ...
          <CardContent className="space-y-4 flex-1 pt-1 p-4 sm:p-6 text-xs text-slate-400 leading-relaxed">
            {careerScore.improvements.map((imp, idx) => (
              <div key={idx} className="flex items-start space-x-2.5">
                <CheckCircle className="w-4.5 h-4.5 text-indigo-400 shrink-0 mt-0.5" />
